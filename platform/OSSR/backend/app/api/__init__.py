...
research_blueprints = [research_data_bp, research_sim_bp, research_report_bp, ais_bp]

__all__ = ["research_blueprints", "research_data_bp", "research_sim_bp", "research_report_bp", "ais_bp"]
